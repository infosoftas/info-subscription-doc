...
Alternatively, head over to the :ref:`Getting Started with the API <getting-started>` section for a more gentle API introduction, or look at our list of :ref:`common scenarios <common-scenarios>`_.
